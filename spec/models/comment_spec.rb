...
RSpec.describe Comment, type: :model do
  ...
  author.save
  post = Post.new(author: author, title: 'Hello', text: 'this a post', comments_couter: 0, likes_counter: 4)
  post.save
  subject { Comment.new(post: post, author: author, text: 'testing comments!') }
  before { subject.save }

  it 'author posts_counter should be 1' do
    expect(post.comments_couter).to eq(1)
  end
